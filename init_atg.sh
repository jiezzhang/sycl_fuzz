...
screen -t "dpcpp-base"    sh -c '. ./atg_profile && . ./ATG/bin/activate &&  mkdir --parents $ATG_WORK_DIR; cd $ATG_WORK_DIR;  python $ATG_HOME_DIR/atg_test.py -c xmain -g dpcpp-base; bash'
